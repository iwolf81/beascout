...
def save_anonymized_data(data: Dict[str, Any], output_path: str):
    """Save anonymized data as Excel file only."""
    ...
    # Always save as Excel format only
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog='''
Examples:
  # Anonymize Key Three Excel file
  python anonymize_key_three.py data/input/Key_3_08-22-2025.xlsx

  # Anonymize with custom output location
  python anonymize_key_three.py data/input/Key_3_08-22-2025.xlsx -o custom/path/anonymized_data

  # Run with verification
  python anonymize_key_three.py data/input/Key_3_08-22-2025.xlsx --verify

This script generates:
  • anonymized_key_three.xlsx (Excel format preserving original structure)

Pipeline Integration:
  # Convert Excel to JSON for pipeline use
  python convert_key_three_to_json.py tests/reference/key_three/anonymized_key_three.xlsx
        ''',
    ...
    try:
        ...
        saved_files = save_anonymized_data(anonymized_data, args.output)
