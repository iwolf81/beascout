# Troop 161 Fiskdale - Key Three Improvement Email
...
- **Contact Email**: kscherer27@aol.com *(Email provided - consider unit-specific email for continuity)*
- **Contact Person**: Kevin Scherer *(Designated contact provided)*
- **Website**: http://troop161MA.org *(Troop-specific website available)*
- **Program Description**: "We are an active Scout Troop based in Sturbridge, MA. We welcome boys ages 11 -
  18 to join us as we learn skills, face challenges, build friendships and
  explore!" *(Welcoming and informative)*
